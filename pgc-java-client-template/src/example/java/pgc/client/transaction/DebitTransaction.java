...
import pgc.client.model.GatewayModelContext;
import pgc.client.model.result.ErrorType;
import pgc.client.model.result.ResultType;
import pgc.client.model.transaction.CreditCardCustomerType;
import pgc.client.model.transaction.DebitType;
import pgc.client.model.transaction.TransactionType;
import pgc.client.signing.HttpHeaders;
import pgc.client.signing.HttpRequestSigner;
import pgc.client.signing.Passwords;
...
public class DebitTransaction {
	...
	public static void main(String[] args) throws IOException, JAXBException {
		...
		TransactionType transaction;
		{
			...
			customer.setEmail("customer-email@client.pgc");
	...
	private static HttpURLConnection transactionRequest(String apiKey, String sharedSecret, TransactionType transaction) throws IOException {
		...
		URL url = new URL("https://gateway.client.pgc/transaction");
