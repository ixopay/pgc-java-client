 ...
 * generated in the pgc.client.model.transaction package. 
...
public class ObjectFactory {
    ...
    private final static QName _Transaction_QNAME = new QName("http://paymentgateway.cloud/Schema/V2/Transaction", "transaction");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pgc.client.model.transaction
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://paymentgateway.cloud/Schema/V2/Transaction", name = "transaction")
