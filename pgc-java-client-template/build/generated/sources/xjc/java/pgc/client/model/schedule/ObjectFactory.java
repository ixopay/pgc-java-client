...
package pgc.client.model.schedule;
 ...
 * generated in the pgc.client.model.schedule package. 
...
public class ObjectFactory {
    ...
    private final static QName _Schedule_QNAME = new QName("http://paymentgateway.cloud/Schema/V2/Schedule", "schedule");
    private final static QName _ScheduleResult_QNAME = new QName("http://paymentgateway.cloud/Schema/V2/ScheduleResult", "scheduleResult");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pgc.client.model.schedule
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://paymentgateway.cloud/Schema/V2/Schedule", name = "schedule")
     ...
     */
    @XmlElementDecl(namespace = "http://paymentgateway.cloud/Schema/V2/ScheduleResult", name = "scheduleResult")
