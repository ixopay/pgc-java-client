...
/**
 * This class is the entry point to the PGCCLIENT tokenization API.
 */
public class TokenizationApi {

	private static final String GATEWAY_HOST = "https://gateway.client.pgc";
	private static final String TOKENIZATION_HOST = "https://secure.client.pgc";
	...
	public static class Builder {
		...
		/**
		 * @param gatewayHost this can be used to switch to a testing/staging environment of the PGCCLIENT gateway.
		 * @return this
		 */
